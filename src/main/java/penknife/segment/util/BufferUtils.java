...
public class BufferUtils {
     ...
     *
     * @param channel The {@link FileChannel} to read from.
     * @param buf     The {@link ByteBuffer} to use as buffer.
     * @param arrays  The array of {@code int[]} to store the read ints.
     ...
     * @throws IOException          If an exception is thrown while reading from {@code channel}.
     * @throws NullPointerException If either channel is null, buf is null, or any element of {@code arrays} is
     *                              null.
     */
