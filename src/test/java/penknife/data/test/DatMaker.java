...
public class DatMaker extends Dat {
     ...
     * @throws IOException If an Instance/O error happens.
     */
     ...
     * @return The generated {@link Dat}.
     * @throws IOException If the given file does not exist or is not readable.
     */
    ...
    private void expandDat() {
        ...
        System.out.println("new length: " + newDat.length);
    ...
    public void buildDat(List<String> words) {
        // construct lexicon
